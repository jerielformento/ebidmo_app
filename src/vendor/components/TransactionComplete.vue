<template>
        ...
        <div class="mx-auto">        
            ...
            <div class="bg-white relative shadow-md sm:rounded-sm overflow-hidden border border-gray-200">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    <h2 class="text-sm font-semibold tracking-tight text-gray-500 block ml-1">Finished Transactions</h2>
                        ...
                        <tbody>
                            <tr v-if="!reloadList" v-for="item in auctionItems" class="border-b hover:bg-gray-100">
                                ...
                                <td colspan="6" class="px-4 py-3">
                                    <div class="grid grid-cols-6 bg-white p-3 rounded-md shadow-sm border border-green-300">
                                        <div class="col-span-6">
                                            ...
                                            <p class="flex items-center font-semibold text-green-500 mb-2"><TruckIcon class="h-5 w-5 mr-2"/> Delivery Information</p>
                                        ...
                                        <div class="col-span-6 flex justify-end items-center text-green-500">
                                            <CheckCircleIcon class="h-5 w-5 mr-1" /> Completed
                                        </div>
                                    </div>
    ...
    <CompleteItemModal v-if="completeItem" :cancel="cancel" :reload="reloadProducts" :id="modal.id"/>
</template>
<script>
    import { ref } from 'vue';
    ...
    const getTransactions = async (page) => {
        ...
        await axiosClient.get('/api/v1/vendor/shipments/complete'+setPage)
            .then(response => {
