<template>
    ...
    <Transition>
        <div class="" v-if="!isLoading">
            <div class="mb-10">
                <!-- Product info -->
                <div class="mx-auto rounded-md shadow-sm bg-white border border-gray-200 max-w-2xl px-4 pt-5 sm:px-6 lg:max-w-full lg:gap-x-8 lg:px-8 lg:pb-6 lg:pt-5">
                ...
                <div class="grid grid-cols-3 mt-4 gap-x-6 lg:mt-0">
                    ...
                    <div class="pb-5 w-full flex justify-between items-center col-span-3">
                        <h1 class="text-2xl font-bold tracking-tight text-gray-800 sm:text-3xl flex items-center justify-start"><img :src="(productInfo.auction.product !== null) ? productInfo.auction.product.thumbnail.url : NoImageUrl" alt="" draggable="false" class="border border-gray-100 rounded-md h-10 w-10 object-cover object-center mr-3"> {{ productInfo.auction.product.name }}</h1>
                    </div>
                        ...
                        <div class="mt-5 col-span-1">
                            ...
                            <div class="mt-3 grid-cols-1 font-semibold text-sm">
                                <div class="block text-sm mb-1"><span
                                            ...
                                            class="text-white text-xs font-semibold rounded-md py-1 px-2">{{ useAcknowledgementStatus(productInfo.status) }}</span></div>
