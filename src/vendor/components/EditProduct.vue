                    ...
                    <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6 mb-5">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-2">
                                ...
                                <input name="images" @change="onFileChange" ref="file" multiple class="block w-auto text-xs text-gray-500 font-semibold border border-gray-200 rounded-md cursor-pointer bg-gray-50 focus:outline-none" id="file_input" type="file">
                        ...
                        <TransitionGroup>
                            ...
                            <div class="relative sm:col-span-1" v-for="(img, index) in url" :key="img" v-if="url !== ''">
                                ...
                                <div class="absolute h-auto w-auto px-1 rounded-md py-0.5 text-xs text-white bg-green-400 top-2 right-2 font-semibold">new</div>
                            </div>
                        </TransitionGroup>
                        ...
                        <div class="sm:col-span-6 flex justify-end border-t border-gray-300">
                            ...
                            <ButtonForm @onClick="submit" text="Update Product" :state="isSubmit" class="mt-3 px-3 py-1.5"/> 
                        </div>
                    </div>
                </div>
            </div>
