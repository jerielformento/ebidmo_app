                ...
                <div class="pt-5">
                    <nav aria-label="Breadcrumb">
                        <ol role="list"
                            ...
                            <li>
                                <div class="flex items-center">
                                    <router-link :to="{ name: 'marketplace' }"
                                        class="mr-2 text-sm font-medium text-gray-900">Category</router-link>
                            ...
                            <li>
                                <div class="flex items-center">
                                    <router-link :to="{ name: 'marketplace', query: { category: productInfo.category.id } }"
                                        class="mr-2 text-sm font-medium text-gray-900">{{ productInfo.category.title
                                        }}</router-link>
                                    <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor" aria-hidden="true"
                                        class="h-5 w-4 text-gray-300">
                                        <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z" />
                            ...
                            <li>
                                <div class="flex items-center">
                                    <router-link :to="{ name: 'marketplace', query: { brand: productInfo.brand.id } }"
                                        class="mr-2 text-sm font-medium text-gray-900">{{ productInfo.brand.description
                                        }}</router-link>
                                    <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor" aria-hidden="true"
                                        class="h-5 w-4 text-gray-300">
                                        <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z" />
                    ...
                    <!-- Product info -->
                    <div
                        class="mx-auto max-w-2xl px-4 pb-16 pt-5 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-16 lg:pt-5">
                        <div class="w-full lg:col-span-2 lg:pr-8">
                            <!-- Image gallery -->
                            <div class="mx-auto sm:px-0 sm:w-full lg:w-full lg:px-16 md:px-5 rounded-md py-4">
                                <swiper :modules="modules" :space-between="20" :loop="true"
                                    :pagination="{ clickable: true }" :thumbs="{ swiper: thumbsSwiper }">
                                ...
                                <swiper :modules="[Thumbs]" watch-slides-progress :slides-per-view="6" :space-between="5"
                                    @swiper="setThumbsSwiper" class="mt-1">
                                    <swiper-slide v-for="text in swiperItems" :key="text.url">
                                        <div class="mx-auto max-w-3xl border-slate-600">
                        ...
                        <!-- Options -->
                        <div
                            class="h-fit mt-4 lg:row-span-3 lg:mt-0 bg-white px-5 py-5 border border-gray-200 shadow-sm rounded-md">
                            <h2 class="sr-only">Product information</h2>
                            <router-link id="tooltipButton"
                                :to="{ name: 'vendor-details', params: { store: productInfo.store.slug } }"
                                class="text-2xl font-medium text-gray-500 hover:text-amber-500 flex items-center">
                            ...
                            <div id="tooltipContent" v-if="productInfo.store.verified === 1" role="tooltip"
                                class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                Verified
                                <div class="tooltip-arrow" data-popper-arrow></div>
                            </div>
                            <div id="tooltipContent" v-if="productInfo.store.verified === 0" role="tooltip"
                                class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                Not Verified
                                <div class="tooltip-arrow" data-popper-arrow></div>
                            </div>
                            ...
                            <!-- <div class="mt-2 pb-2 border-b border-gray-200">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <a href="#" class="ml-3 text-sm font-medium text-amber-500 hover:text-amber-400">117
                                        reviews</a>
                                </div>
                            </div> -->
                            ...
                            <div class="mt-2">
                                <div class="block text-sm">
                                    <h3 class="inline-block">Category:</h3> <a href="#" class="underline text-amber-500">{{
                                        productInfo.category.title }}</a>
                                </div>
                                <div class="block text-sm">
                                    <h3 class="inline-block">Brand:</h3> <a href="#" class="underline text-amber-500">{{
                                        productInfo.brand.description }}</a>
                                </div>
                                <div class="block text-sm">
                                    <h3 class="inline-block">Condition:</h3> <span class="text-gray-500">{{
                                        productInfo.condition.description }}</span>
                                </div>
                                <div class="block text-sm">
                                    <h3 class="inline-block">Location:</h3> <span class="text-gray-500">{{
                                        productInfo.item_location.name }}</span>
                                </div>
                            </div>
                            <div v-if="!productInfo.owner" class="mt-5">
                                <div v-if="productInfo.auction !== null">
                                    <div
                                        class="p-4 border border-gray-200 rounded-lg bg-gray-50 dark:border-gray-600 dark:bg-gray-800"
                                        role="alert">
                                        <div class="flex items-center">
                                            <span class="sr-only">Info</span>
                                            <h3 class="text-lg font-medium text-gray-800 dark:text-gray-300">Item is currently live in the auction!</h3>
                                        </div>
                                        <div class="mt-2 mb-4 text-sm text-gray-800 dark:text-gray-300">
                                            Check it out! You can participate by placing your bid to win this item.
                                        </div>
                                        <div class="flex">
                                            <router-link
                                                :to="{ name: 'auction-details', params: { store: productInfo.store.slug, id: productInfo.slug } }"
                                                class="text-white bg-red-500 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-xs px-3 py-1.5 mr-2 text-center inline-flex items-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                                                View Auction
                                            </router-link>
                                        </div>
                                    </div>
                                ...
                                <div v-else>
                                    <div
                                        ...
                                        <div class="text-sm text-gray-400 dark:text-gray-300">
                                            This item is not in auction right now
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div v-else>
                                <div
                                    class="mt-5 grid grid-cols-1 items-center p-3 bg-sky-50 border border-sky-200 rounded-md shadow-sm text-md text-gray-700">
                        ...
                        <div class="mt-5 bg-white px-5 py-10 lg:col-span-2 lg:col-start-1 border border-gray-200 shadow-sm rounded-md lg:pb-16 lg:pt-6">
                            ...
                            <div class="mb-5 w-full lg:col-span-2 flex justify-between items-center">
                                ...
                                <div class="inline-flex space-x-3">
                                    <ShareNetwork network="facebook" :url="siteUrl + route.fullPath"
                                        :title="productInfo.name" :description="productInfo.name" hashtags="ebidmo,auction">
                        ...
                        <div class="py-10 lg:col-span-2 lg:col-start-1 lg:pb-8">
                            <Suspense>
                                <StoreProductSuggestion :store="productInfo.store.slug" :product="productInfo.slug" />
                            </Suspense>
                            <Suspense>
                                <StoreSimilarProductSuggestion :store="productInfo.store.slug"
...
<style scoped>.swiper-thumbs .swiper-slide-thumb-active {
